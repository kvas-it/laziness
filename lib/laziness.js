...
LazyValue.prototype.done = function (onSuccess, onError) {
...
/* Wrapper for functions with callbacks.
 */
function lazyNodeFunction(f) {
    return lazyFunction(function () {
        return Q.nfapply(f, arguments);
    });
}
